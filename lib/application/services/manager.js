    ...
    if( name ){
        if( typeof(service) === 'string' ){
            try{
                ...
                this.app.throw( error.new(this.ERROR_ADD_INVALID_PATH.concat({name:name,path:path})) );
            }
        }
        ...
        this.app.throw( error.new(this.ERROR_ADD_INVALID_SERVICE.concat({name:name,path:path})) );
    }
