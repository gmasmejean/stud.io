...
var moduleManager = require('./modules/manager'),
    serviceManager = require('./services/manager'),
    viewManager = require('./views/manager'),
    routeManager = require('./routes/manager'),
    eventManager = require('./events/manager'),
    helperManager = require('./helpers/manager'),
...
var application = function(configuration){
    ...
    this.configure(util.extend(require('../application.conf'),configuration||{}),this.ready.bind(this));
};
